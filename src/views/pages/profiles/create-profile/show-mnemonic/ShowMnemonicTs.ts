...
import { IHDAccountInfo, VeritisePaperWallet } from 'veritise-paper-wallets';
...
export default class ShowMnemonicTs extends Vue {
    ...
    public async processDownload() {
        ...
        const paperWallet = new VeritisePaperWallet(rootAccountInfo, [], this.currentProfile.networkType, this.currentProfile.generationHash);
