...
export const defaultMainnetNetworkConfig: NetworkConfig = {
    ...
    networkConfigurationDefaults: {
        ...
        currencyMosaicId: '4782D8157E9B12D8',
        harvestingMosaicId: '4782D8157E9B12D8',
        defaultDynamicFeeMultiplier: 1000000,
        epochAdjustment: 1644905554,
        totalChainImportance: 301417791900000,
        generationHash: '6F3BB068920937930E86215F83AA952C5D3342522C980DD0FF3BDAC02988E4EE',
    },
    nodes: [
        { friendlyName: 'veritise-dual2', roles: 7, url: 'http://dual1-mainnet.veritise.superhow.net:3000' },
        { friendlyName: 'veritise-dual1', roles: 7, url: 'http://dual2-mainnet.veritise.superhow.net:3000' },
